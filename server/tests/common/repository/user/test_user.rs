...
use syntaxmakers_server::{
    common::{
        ...
        repository::{
            ...
            user::{models::{AuthenticateResult, DeveloperOrEmployer}, repo::AuthenticateDbFn}
        }
    }, 
    common_test::fixtures::{get_app_data, get_fake_dev_desc, get_fake_fullname, init_fixtures, MockEmailer}
};
